...
@Component({
  selector: 'app-spirals',
  templateUrl: './spirals.component.html',
  styleUrls: ['./spirals.component.css']
})
export class SpiralsComponent implements OnInit {

  @ViewChild('spirals') canvasRef1: ElementRef;
